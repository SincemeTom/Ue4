...
#define LOCTEXT_NAMESPACE "FSlateExtensionEditorCommands"

void FSlateExtensionEditorCommands::RegisterCommands()
{
		UI_COMMAND(SlateButton, "Slate Button", "Test Button", EUserInterfaceActionType::Button, FInputChord());
